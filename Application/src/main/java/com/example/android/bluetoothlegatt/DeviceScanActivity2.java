...
import uk.co.jatra.ble.RxBle;
import uk.co.jatra.ble.ScanResult;
...
public class DeviceScanActivity2 extends ListActivity {
    ...
    private void scanLeDevice(final boolean enable) {
        if (enable) {
            ...
            RxBle.scan(mBluetoothAdapter, null, mScanSettings)
    ...
    public void handleResult(ScanResult scanResult) {
        final BluetoothDevice device = scanResult.getScanResult().getDevice();
        Log.d(TAG, "handleResult device " + device + " on thread: " + Thread.currentThread().toString());
